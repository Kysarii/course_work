...
class Game:
    ...
    def show_rules(self):
        messagebox.showinfo("Правила игры", "Правила игры:\n"
                            ...
                            "2. Дамка ходит на любое количество пустых полей вперёд, назад, вправо, влево. \n"
                            ...
                            "4. Простая шашка, вступившая на восьмую горизонталь, становится дамкой. \n"
                            "5. Выигрывает тот, кто смог уничтожить все шашки противника, либо тот, кто остался с несколькими своими простыми шашками против одной простой шашки противника. \n"
                            "6. Если на доске осталось по одной шашке — объявляется ничья.")
